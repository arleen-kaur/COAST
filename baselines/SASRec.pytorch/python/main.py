...
if __name__ == '__main__':
    ...
    if args.state_dict_path is not None:
        try:
            ...
            print(e)
            print(
                "Hint: checkpoints live in <dataset>_<train_dir>/ e.g. beauty_default/ "
                "and are named SASRec.epoch=....pth (run training from this python/ folder)."
            )
            sys.exit(1)
    ...
    for epoch in range(epoch_start_idx, args.num_epochs + 1):
        ...
        # Original repo only evaluated every 20 epochs; short runs (e.g. num_epochs=10)
        # would finish with no NDCG/HR printed and no best checkpoint saved.
        ...
        if epoch == args.num_epochs:
            ...
            print(f"Saved final checkpoint: {ckpt_path}", flush=True)
